...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
  ...
  case RCC_PERIPHCLK_SAI2: {
    ...
    case RCC_DCKCFGR_SAI2SRC_1: /* PLLR is the clock source for SAI*/
    {
      ...
      frequency =
          (vcoinput * ((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6U)) / (tmpreg1);
      break;
    }
  ...
  case RCC_PERIPHCLK_I2S_APB1: {
    ...
    case RCC_I2SAPB1CLKSOURCE_PLLI2S: {
      ...
      if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) {
        ...
        vcoinput = (uint32_t)(HSE_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                     RCC_PLLI2SCFGR_PLLI2SM));
      } else {
        /* Get the I2S source clock value */
        vcoinput = (uint32_t)(HSI_VALUE / (uint32_t)(RCC->PLLI2SCFGR &
                                                     RCC_PLLI2SCFGR_PLLI2SM));
      }
    ...
    /* Check if I2S clock selection is PLL VCO Output divided by PLLR used as
     * I2S clock */
    case RCC_I2SAPB1CLKSOURCE_PLLR: {
      ...
      frequency =
          (uint32_t)(vcooutput / (((RCC->PLLCFGR & RCC_PLLCFGR_PLLR) >> 28U) &
