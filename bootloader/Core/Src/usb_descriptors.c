...
// Number of Alternate Interface
#define ALT_COUNT 1

enum { ITF_NUM_DFU_MODE, ITF_NUM_TOTAL };
...
uint8_t const desc_configuration[] = {
    ...
    TUD_DFU_DESCRIPTOR(ITF_NUM_DFU_MODE, ALT_COUNT, 4,
                       (DFU_ATTR_CAN_DOWNLOAD | DFU_ATTR_WILL_DETACH), 1000,
...
#define MS_OS_20_DESC_LEN                                                      \
  (MS_OS_20_SET_HEADER_LEN + MS_OS_20_FEATURE_COMPATBLE_ID_LEN +               \
...
uint8_t const desc_ms_os_20[] = {
    ...
    // Compatible ID
    // We use WinUSB to install generic USB driver for DFU mode
    ...
    '{', 0x00, '4', 0x00, '8', 0x00, 'F', 0x00, '6', 0x00, '8', 0x00, '0', 0x00,
    '6', 0x00, '8', 0x00, '-', 0x00, 'F', 0x00, '3', 0x00, '6', 0x00, '9', 0x00,
    '-', 0x00, '4', 0x00, '8', 0x00, '0', 0x00, 'B', 0x00, '-', 0x00, '8', 0x00,
    '4', 0x00, '4', 0x00, 'E', 0x00, '-', 0x00, '2', 0x00, '1', 0x00, '1', 0x00,
    '1', 0x00, 'F', 0x00, '8', 0x00, '0', 0x00, '4', 0x00, '4', 0x00, 'E', 0x00,
    'A', 0x00, '8', 0x00, '}', 0x00, 0x00, 0x00, 0x00, 0x00};
...
char const *string_desc_arr[] = {
    ...
    USB_DFU_MODE_NAME,          // 4: DFU partition
};
